...
// console.log(meal["Pizza"]);
var newPizza = "Pizzasss";
// console.log(meal[newPizza]);
// console.log(meal.newPizza);
for (var key in meal) {
    console.log(meal[key], "log000");
...
// const a: Source = b;
console.log({ a: a });
for (var key in montlyIncomes) {
    console.log(montlyIncomes[key], "log001");
}
